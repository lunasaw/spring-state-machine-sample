package com.sample.springstatemachine.application.config;

import com.sample.springstatemachine.application.events.ApplicationReviewEvents;
import com.sample.springstatemachine.application.state.ApplicationReviewStates;
